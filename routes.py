...
def single_song(song_id):
    ...
    print("Rendering page with song = " + str(song) + "and metadata = " + str(songmetadata))
...
def add_song():
    ...
    if request.method == 'POST':
        ...
        song = database.add_song_to_db(newdict['storage_location'],newdict['description'],newdict['song_title'],newdict['song_length'],newdict['song_genre'],newdict['artist_ID'], newdict['artwork'],newdict['artist_name'])
